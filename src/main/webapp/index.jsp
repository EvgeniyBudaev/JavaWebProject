        ...
        <div class="row">
            <div class="col-sm-12">
                <nav class="navbar navbar-expand-lg navbar-light">
                    <a class="navbar-brand" href="#"><img src="./img/logo.png" alt=""> Проект</a>
                    ...
                    <div class="collapse navbar-collapse" id="navbarSupportedContent">
                        <div class="header_content ml-auto">
                            <div class="nav-item"><a class="nav-link" href="/students_list">Студенты</a></div>
                            <div class="nav-item"><a class="nav-link" href="/list_of_disciplines">Дисциплины</a></div>
                            <div class="nav-item"><a class="nav-link" href="/term_list">Семестры</a></div>
...
<div class="container">
    <div class="row">
        <div class="col-md-4">
            <a class="decor" href="/students_list">
                <div class="card">
                    <div class="card-body">
                        <div class="logo-img">
        ...
        <div class="col-md-4">
            <a class="decor" href="/list_of_disciplines">
                <div class="card">
                    <div class="card-body">
                        <div class="logo-img">
